...
const article: Article = {
  slug: 'sme-valuations-key-considerations',
  title: 'Key Considerations for SME Valuations',
  excerpt:
    'Understanding the nuances of valuing small to medium enterprises in today\'s market, including both traditional methods and modern approaches.',
  content: `
