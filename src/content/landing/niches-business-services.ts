    ...
    contentTodos: [
      {
        ...
        body: [
          ...
          "The phone has likely been ringing. There are 6 to 10 active PE-backed payroll consolidators acquiring in the UK at any given time {{ STATS_CHECK: count of active UK payroll bureau consolidators 2024–2026 }}, plus strategic acquirers in HR technology and accountancy looking to add payroll capability. The question is rarely whether to sell — it is whether the approach you have received reflects what the market would actually pay.",
          ...
          "This is not the right fit if your business is below £5M EV, or if your retention story relies on numbers you cannot reproduce from the underlying systems. The readiness phase is the place to address both, before any process. See [exit planning](/services/exit-planning-advisor-uk/) for how that runs.",
        ],
      },
      {
        ...
        body: [
          ...
          "Annual client retention first. Buyers will diligence retention down to individual client tenure across the top 50 clients. Premium pricing requires consistent retention above 95% {{ STATS_CHECK: retention threshold for premium pricing in UK payroll bureaux 2024–2026 }}. Below that, the multiple discounts steeply, and below 90% the buyer pool narrows materially.",
    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "Contract tail and renewal rates first. Average weighted contract tail across the top 20 contracts is one of the first numbers buyers ask for. Books with 36+ months of tail and renewal rates above 85% command premium pricing {{ STATS_CHECK: contract tail and renewal benchmarks for UK FM lower mid-market 2024–2026 }}. Books on rolling 12-month terms with churn above 20% trade at a discount regardless of headline EBITDA.",
    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "Contract tail and renewal rates first. Average weighted contract tail across the top 20 clients is the headline metric. Books with 24+ months of weighted tail and renewal rates above 80% support premium pricing {{ STATS_CHECK: contract tail benchmarks for UK commercial cleaning lower mid-market }}. Rolling 12-month books with churn above 25% trade meaningfully lower.",
    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "NFI quality first. Buyers will diligence NFI by consultant, by client, by sector, by month, and through the cycle. Premium pricing requires NFI that has held or grown through the 2023-2024 market dip {{ STATS_CHECK: UK recruitment market cyclicality benchmarks 2023–2026 }}, with low concentration by consultant and client.",
