    ...
    contentTodos: [
      {
        ...
        body: [
          ...
          "The buyer pool for UK specialist manufacturing is international and well-funded. German, US and Japanese strategic acquirers are frequent buyers of UK specialist manufacturing businesses with differentiated technical capability {{ STATS_CHECK: international strategic acquirer activity in UK specialist manufacturing 2024–2026 }}. PE consolidators executing buy-and-build across defined manufacturing niches form a deep secondary pool. Direct PE houses look for platform investments at the upper end of our EV segment.",
    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "Utilisation and asset-level metrics second. Utilisation rate by asset class, average rental rate per asset per day, time-on-hire profile, and the trajectory of each. Premium pricing requires consistent utilisation above 70-75% on rentable fleet {{ STATS_CHECK: utilisation benchmarks for UK specialist plant hire 2024–2026 }}, with rate discipline through the cycle.",
    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "Recurring service revenue fifth. Many process engineering businesses build a recurring service and maintenance book on top of installed projects. This income is valued at a meaningful premium to project revenue because of visibility. We help owners surface and segment the recurring book clearly.",
        ],
      },
      {
        heading: 'Our process',
