    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "Occupancy and FTE clients second. For residential care, average occupancy across the portfolio and per-site is the headline. For domiciliary care, FTE clients, weekly hours delivered, and client retention. Premium pricing requires consistent occupancy above 88-90% in residential and stable FTE client growth in domiciliary {{ STATS_CHECK: occupancy benchmarks for UK residential care 2024–2026 }}.",
    ...
    contentTodos: [
      {
        ...
        body: [
          ...
          "The buyer pool is unusually concentrated and well-funded for the size of the sector. PE-backed mental health consolidators have been very active over the last three years, particularly in CAMHS and complex-needs adult provision {{ STATS_CHECK: PE consolidator activity in UK mental health services 2024–2026 }}. Strategic acquirers include larger UK healthcare groups and a small number of overseas strategics. The narrower the buyer pool, the more buyer mapping accuracy matters.",
    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "Client contract tail first. Weighted average tail across the top 20 clients is the headline metric. Books with 24+ months of weighted tail and renewal rates above 85% support premium pricing {{ STATS_CHECK: contract tail benchmarks for UK OH lower mid-market 2024–2026 }}. Rolling 12-month books trade meaningfully lower regardless of headline revenue.",
