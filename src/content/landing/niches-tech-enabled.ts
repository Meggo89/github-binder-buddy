    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "ARR composition and SaaS metrics first. Net revenue retention, gross revenue retention, gross margin on the recurring book, CAC payback, rule of 40, ARR growth rate and ARR cohort durability. Premium pricing requires NRR above 105-110% with low logo churn and consistent cohort retention {{ STATS_CHECK: NRR/GRR benchmarks for UK vertical SaaS lower mid-market 2024–2026 }}. Buyers will calculate these from raw billing data — pre-process work to clean and present the metrics correctly is essential.",
    ...
    contentTodos: [
      ...
      },
      {
        ...
        body: [
          ...
          "Contracted MRR and revenue composition first. The single most important metric. Premium pricing requires contracted MRR representing more than 70% of revenue with documented forward visibility {{ STATS_CHECK: contracted MRR benchmark for UK MSP premium pricing 2024–2026 }}. Buyers will calculate MRR from raw billing data and segment by contract type.",
