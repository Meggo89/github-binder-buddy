import type { SectorPillar } from "./types";

export const SECTORS: SectorPillar[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Buyers prioritise recurring revenue, low customer concentration, defensible margins, a leadership team that survives the founder transition, and clean financial reporting. They also look for evidence of pricing discipline and operating leverage. Pre-process readiness work focuses on making these visible rather than inventing them.",
      },
      {
        q: "Do you only handle full exits, or also minority sales?",
        a: "Both. We advise on full sales, majority sales (founder retains a meaningful stake), management buyouts and minority growth-capital rounds. The structure follows the owner objective, not the other way round.",
      },
      {
        q: 'What does "off-market" actually mean in practice?',
        a: "It means we approach a curated set of strategic and PE buyers directly under NDA, rather than listing the business on broker networks or M&A databases. This protects confidentiality, prevents staff/customer leakage, and frequently uncovers buyers other advisors do not reach.",
      },
      {
        q: "How are your fees structured?",
        a: "Mastella works on a low monthly retainer model that aligns to delivery, not deal commission. We share the structure transparently in the first conversation. The retainer model funds genuinely senior-led delivery rather than juniors running the work behind Leo.",
      },
    ],
    whoWeWorkWith: {
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Two pools: PE-backed consolidators (rolling up dental, vet, care, mental health) and a smaller number of strategic acquirers — typically larger groups expanding by geography or service line. Our buyer mapping identifies the active consolidators and where each is in their buy-and-build cycle.",
      },
      {
      ...
      },
      {
        ...
        a: "Not from us. Our off-market approach means we contact a curated list of acquirers under NDA. We never list the business on databases or broker networks. Staff and clients learn about the transaction at the point you choose to tell them, typically post-exchange.",
      },
      {
        q: "Do you handle single-site sales or only multi-site groups?",
        a: "Both. We work on single-site sales at the upper end of the owner-managed segment (typically £5M+ EV) and on multi-site groups up to £50M. Below the £5M threshold we will refer you to a small set of brokers we trust rather than take a mandate we cannot deliver senior-led.",
      },
    ],
    whoWeWorkWith: {
      heading: "Who we work with",
    ...
    whatBuyersLookFor: {
      ...
      cover: [
        ...
        "Site economics, occupancy / chair-time / case-load metrics",
  ...
  {
    slug: "light-industrials",
    name: "Light industrials",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Strategic UK and overseas acquirers seeking sector adjacency or geographic expansion, PE consolidators executing buy-and-build strategies, and direct PE houses for platform investments. Trade buyers dominate at the smaller end; PE becomes more active above ~£15M EBITDA.",
      },
      {
        q: "How does asset intensity affect valuation?",
        a: "Buyers value the cash earnings the assets generate, not the assets themselves. Asset-intensive businesses (plant hire, capital equipment) are valued on EBITDA less expected maintenance capex, and on the quality / age profile of the fleet. We work with owners to present this cleanly and benchmark it against comparable transactions.",
      },
      {
      ...
      },
      {
        ...
        a: "Customer concentration above 25% of revenue from a single customer is a flag for most buyers but not usually a deal-breaker. We work with owners pre-process to document the depth of the customer relationship (contract tail, switching cost, length of relationship) so it can be defended properly in diligence.",
      },
      {
        q: "Do international buyers participate in UK light industrial sales?",
        a: "Yes, frequently. European, North American and increasingly Asian strategic acquirers are active in UK specialist manufacturing, particularly where the target has differentiated technical capability or established export channels. Our buyer mapping covers these pools as standard.",
      },
    ],
    whoWeWorkWith: {
      heading: "Who we work with",
    ...
    whatBuyersLookFor: {
      ...
      cover: [
        ...
        "Technical capability that creates pricing power",
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Three buyer pools: large strategic logistics groups (UK and European) seeking capability or geographic fill-in, PE consolidators rolling up specialist segments, and infrastructure-style investors targeting cold-chain and warehousing for predictable yield.",
      },
      {
        q: "How does fleet age affect valuation?",
        a: "Buyers value cash earnings net of expected maintenance and replacement capex. A young fleet supports a higher multiple because reported EBITDA more closely reflects sustainable earnings. Pre-process we typically build a clean capex normalisation so the EBITDA bridge is transparent to buyers.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes. A significant portion of UK logistics interest comes from European and global strategic acquirers. Our buyer mapping covers these pools and we work with specialist tax and legal counsel for cross-border structuring.",
      },
    ],
    whoWeWorkWith: {
      heading: "Who we work with",
    ...
    whatBuyersLookFor: {
      ...
      cover: [
        ...
        "Margin per route / per unit metrics",
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Partner equity structures are one of the most material variables in a professional services sale. Where multiple partners hold equity, we work with the partnership pre-process to align on objectives, vesting, lock-ins, and how proceeds will flow. Lack of partner alignment is the single most common reason professional services sales stall.",
      },
      {
        q: "Who buys UK professional services firms?",
        a: "Three pools: PE-backed consolidators (very active in accountancy, growing in legal), strategic firms looking for capability or geographic fill-in, and overseas firms looking for UK footprint. Our buyer mapping identifies the current active consolidators and where each is in their cycle.",
      },
      {
        q: "What about client retention through a sale?",
        a: "Client retention is the single biggest concern in any professional services diligence. Strong written client agreements, low concentration, partner lock-ins and a clear post-sale leadership plan all materially de-risk this. We help owners build a credible client retention story before going to market.",
      },
      {
      ...
      },
      {
        ...
        a: "Not from us. Our off-market approach contacts a curated buyer set under NDA only. Clients and team learn about the transaction at the point you choose, typically post-exchange.",
      },
    ],
    whoWeWorkWith: {
      heading: "Who we work with",
    ...
    whatBuyersLookFor: {
      ...
      cover: [
        ...
        "Client concentration and retention metrics",
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Materially. The market values SaaS / recurring revenue at a meaningful premium to services revenue. We work with owners pre-process to surface and properly classify the SaaS / recurring component so the right valuation methodology is used and the right buyer pool is approached.",
      },
      {
        q: "Who buys UK tech-enabled services businesses?",
        a: "PE-backed consolidators (very active in MSPs, digital, vertical SaaS), strategic acquirers seeking technology or capability, and overseas (US, Nordic, French) strategics expanding into the UK market. Different sub-sectors have very different buyer compositions.",
      },
      {
      ...
      },
      {
        ...
        a: "Founder dependency — particularly on technical knowledge or major client relationships — is the most common diligence flag in this sector. We work with owners 12+ months pre-process to build out the senior team and document key relationships so the business is genuinely sellable.",
      },
      {
        q: "Does AI exposure affect valuation today?",
        a: "Yes, in both directions. Buyers are willing to pay a premium for genuine AI-native or AI-augmented capability, and increasingly cautious about businesses materially exposed to disintermediation risk. We help owners frame their AI position honestly so it strengthens rather than weakens the narrative.",
      },
      {
        q: "How are your fees structured?",
    ...
    whatBuyersLookFor: {
      ...
      cover: [
        ...
        "Founder dependency and senior team depth",
...
export const SECTORS_BY_SLUG = new Map(SECTORS.map((s) => [s.slug, s]));

export function getSector(slug: string): SectorPillar | undefined {
